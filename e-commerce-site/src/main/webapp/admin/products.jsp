      ...
      <div class="container-fluid">
        <div class="card">
          ...
          <div class="card-body">
            <table id="productTable" class="table table-bordered table-hover">
              ...
              <%
                ...
                <tr>
                  ...
                  <td><%=i.getCategory() %></td>
                  <td>
                    <a href="update_product.jsp?id=<%= i.getId() %>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i> Düzenle</a>
                    <a href="delete-product?id=<%= i.getId() %>" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i> Sil</a>
                  </td>
                </tr>
            ...
            <br>
            <div class="mx-auto" style="width: 200px;"><a href="create_product.jsp" class= "btn btn-warning btn-sm"><i class="fas fa-plus"></i> Ekle</a></div>
